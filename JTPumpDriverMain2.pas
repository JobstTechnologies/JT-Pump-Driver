...
type
  ...
  TMainForm = class(TForm)
    ...
    Result1FSE3: TLabeledEdit;
    Result1FSE4: TLabeledEdit;
    Result1FSE5: TLabeledEdit;
    Result1FSE6: TLabeledEdit;
    Result1FSE7: TLabeledEdit;
    Result2FSE2: TLabeledEdit;
    Pump3ResultLE1: TLabeledEdit;
    Result2FSE3: TLabeledEdit;
    Result2FSE4: TLabeledEdit;
    Result2FSE5: TLabeledEdit;
    Result2FSE6: TLabeledEdit;
    Result2FSE7: TLabeledEdit;
    Result3FSE2: TLabeledEdit;
    Pump4ResultLE1: TLabeledEdit;
    Result3FSE3: TLabeledEdit;
    Result3FSE4: TLabeledEdit;
    Result3FSE5: TLabeledEdit;
    Result3FSE6: TLabeledEdit;
    Result3FSE7: TLabeledEdit;
    Result4FSE2: TLabeledEdit;
    Result4FSE3: TLabeledEdit;
    Result4FSE4: TLabeledEdit;
    Result4FSE5: TLabeledEdit;
    Result4FSE6: TLabeledEdit;
    Result4FSE7: TLabeledEdit;
